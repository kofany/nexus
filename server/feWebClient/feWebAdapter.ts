...
export class FeWebAdapter {
    ...
    private registerHandlers(): void {
        ...
        this.socket.onMessage("channel_join", (msg) => void this.handleChannelJoin(msg));
        ...
        this.socket.onMessage("state_dump", (msg) => void this.handleStateDump(msg));

        // 17. query_opened - Query window opened
        this.socket.onMessage("query_opened", (msg) => void this.handleQueryOpened(msg));
