...
import Busboy, {type Busboy as BusboyInstance, type BusboyHeaders} from "@fastify/busboy";
...
class Uploader {
    ...
    static routeUploadFile(this: void, req: Request, res: Response) {
        ...
        if (!busboyInstance) {
            return abortWithError(Error("Failed to initialize upload handler"));
        }
