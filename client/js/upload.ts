...
class Uploader {
	...
	uploadNextFileInQueue(token: string) {
		...
		// This issue only happens if NexusIRC is proxied through other software
		// as it may buffer the upload before the upload request will be processed by NexusIRC.
