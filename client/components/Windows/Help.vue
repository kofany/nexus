	...
	<div id="help" class="window" role="tabpanel" aria-label="Help">
		...
		<div class="container">
			...
			<div class="about">
				...
				<template v-if="store.state.serverConfiguration?.gitCommit">
					...
					<ul>
						<li>
							Compare
							<a
								:href="`https://github.com/erssi-org/nexuslounge/compare/${store.state.serverConfiguration?.gitCommit}...main`"
								target="_blank"
								rel="noopener"
								>between
						...
						<li>
							Compare
							<a
								:href="`https://github.com/erssi-org/nexuslounge/compare/${store.state.serverConfiguration?.version}...${store.state.serverConfiguration?.gitCommit}`"
								target="_blank"
								rel="noopener"
								>between
				...
				<p>
					<a
						href="https://github.com/erssi-org/nexuslounge"
						target="_blank"
						rel="noopener"
						class="website-link"
						>GitHub Repository</a
				...
				<p>
					<a
						href="https://github.com/thelounge/thelounge/tree/master/docs"
						target="_blank"
						rel="noopener"
				...
				<p>
					<a
						href="https://github.com/erssi-org/nexuslounge/issues/new"
						target="_blank"
						rel="noopener"
