...
<html lang="en">
    ...
    <link rel="manifest" href="nexusirc.webmanifest">
    ...
    <meta name="application-name" content="NexusIRC">
        ...
        <div id="loading">
            <div class="window">
                <div id="loading-status-container">
                    ...
                    <p id="loading-page-message">NexusIRC requires a modern browser with JavaScript enabled.</p>
                </div>
