...
<html lang="en">
    ...
    <link rel="manifest" href="nexuslounge.webmanifest">
    ...
    <meta name="application-name" content="Nexus Lounge">
        ...
        <div id="loading">
            <div class="window">
                <div id="loading-status-container">
                    ...
                    <p id="loading-page-message">Nexus Lounge requires a modern browser with JavaScript enabled.</p>
                </div>
